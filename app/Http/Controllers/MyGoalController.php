...
class MyGoalController extends Controller
{
    function index(Request $request) {
        ...
        $datasQuery = ApprovalRequest::with(['employee', 'goal', 'initiated', 'manager', 'adjusted', 'approval' => function ($query) {
        ...
        return view('pages.goals.my-goal', compact('data', 'link', 'formData', 'uomOption', 'typeOption'));
