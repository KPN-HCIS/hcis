            ...
            <div class="table-responsive">
                <table class="table table-hover" id="reportGoalsTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      @foreach ($data as $row)
                        <tr>
                          <td>{{ $row->employee->fullname.' '.$row->employee_id }}</td>
                          ...
                          <td class="text-center">
                            <a href="#" id="approval" class="badge {{ $row->status === 'Approved' ? 'badge-success' : 'badge-warning'}} badge-pil px-3">{{ $row->status }}</a>
                          </td>
                          <td class="text-center">{{ $row->created_at }}</td>
                          <td class="text-center">{{ $row->initiated->name.' '.$row->initiated->employee_id }}</td>
