        ...
        <div class="d-sm-flex align-items-center justify-content-center">
            <div class="card col-md-8">
                ...
                <div class="card-body" @style('overflow-y: auto;')>
                    <div class="container-fluid">
                        <form id="scheduleForm" method="post" action="{{ route('ticket.update', encrypt($transactions->id)) }}">@csrf
                            <div class="row my-2">
                                <div class="col-md-6">
                                    <div class="mb-2">
                            ...
                            <div class="col-md-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="bisnis_numb" id="bisnis_numb" value="{{ $transactions->no_sppd }}" class="form-control bg-light" readonly>
                                </div>
                            </div>
                            <div class="row my-2">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-2 mr-0">
                                        <select class="form-control" id="jk_tkt" name="jk_tkt" required>
                                            <option value="">-</option>
                                            <option value="Mr" {{ $transactions->jk_tkt == 'Mr' ? 'selected' : '' }}>Mr</option>
                                            <option value="Mrs" {{ $transactions->jk_tkt == 'Mrs' ? 'selected' : '' }}>Mrs</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        <input type="text" name="np_tkt" id="np_tkt" class="form-control" value="{{ $transactions->np_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <input type="number" name="noktp_tkt" id="noktp_tkt" class="form-control" value="{{ $transactions->noktp_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                        <label class="form-label" for="tlp_tkt">Nomor Telephone</label>
                                        <input type="number" name="tlp_tkt" id="tlp_tkt" class="form-control" maxlength="12" value="{{ $transactions->tlp_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                        ...
                                        <select class="form-select" name="jenis_tkt" required>
                                            <option value="Pesawat" {{ $transactions->jenis_tkt == 'Pesawat' ? 'selected' : '' }}>Pesawat</option>
                                            <option value="Kereta" {{ $transactions->jenis_tkt == 'Kereta' ? 'selected' : '' }}>Kereta</option>
                                            <option value="Bus" {{ $transactions->jenis_tkt == 'Bus' ? 'selected' : '' }}>Bus</option>
                                            <option value="Ferry" {{ $transactions->jenis_tkt == 'Ferry' ? 'selected' : '' }}>Ferry</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="dari_tkt" id="dari_tkt" class="form-control" value="{{ $transactions->dari_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                        <label class="form-label" for="start">Kota Kedatangan</label>
                                        <input type="text" name="ke_tkt" id="ke_tkt" class="form-control" value="{{ $transactions->ke_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        <label class="form-label" for="tgl_brkt_tkt">Tanggal Berangkat</label>
                                        <input type="date" name="tgl_brkt_tkt" id="tgl_brkt_tkt" class="form-control" value="{{ $transactions->tgl_brkt_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-2">
                                        <label class="form-label" for="jam_brkt_tkt">Jam Keberangkatan</label>
                                        <input type="time" name="jam_brkt_tkt" id="jam_brkt_tkt" class="form-control" value="{{ $transactions->jam_brkt_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                        ...
                                        <select name="type_tkt" id="type_tkt" class="form-select" onchange="toggleDivs()">
                                            <option value="One-Way" {{ $transactions->type_tkt == 'One-Way' ? 'selected' : '' }}>One-Way</option>
                                            <option value="Round-Trip" {{ $transactions->type_tkt == 'Round-Trip' ? 'selected' : '' }}>Round-Trip</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2" id="div_ticket">
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        ...
                                        <input type="date" name="tgl_plg_tkt" id="tgl_plg_tkt" class="form-control" value="{{ $transactions->tgl_plg_tkt }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-2">
                                        <label class="form-label" for="jam_plg_tkt">Jam Kepulangan</label>
                                        <input type="time" name="jam_plg_tkt" id="jam_plg_tkt" class="form-control" value="{{ $transactions->jam_plg_tkt }}">
                                    </div>
                                </div>
                            </div>
                            <br>
