                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" name="transport" id="transport" type="text" min="0" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="mb-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" name="accommodation" id="accommodation" type="text" min="0" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="mb-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" name="other" id="other" type="text" min="0" value="0">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control bg-light" name="totalca" id="totalca" type="text" min="0" value="0" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
