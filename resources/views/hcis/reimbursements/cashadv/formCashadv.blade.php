                            ...
                            <div class="row my-2">
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control bg-light" placeholder="Enter Destination.." id="destination" name="destination" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        ...
                                        <textarea name="ca_needs" id="ca_needs" class="form-control bg-light"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        ...
                                        <input type="date" name="start_date" id="start_date" class="form-control bg-light" placeholder="mm/dd/yyyy" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        ...
                                        <input type="date" name="end_date" id="end_date" class="form-control bg-light" placeholder="mm/dd/yyyy" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        ...
                                        <input type="date" name="ca_required" id="ca_required" class="form-control bg-light" placeholder="mm/dd/yyyy" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-md-5">
                                    <div class="mb-2">
                                        ...
                                        <select name="ca_type" class="form-select bg-light">
                                            <option value="ca_bt">CA Business Trip</option>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive-sm">
                                        <table class="table table-hover table-centered mb-0">
                                            <thead>
                                                <tr>
                                                    <th colspan=4>Estimated Cash Advanced</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="width:25%">Allowance</td>
                                                    <td style="width:30%"><input type="number" min="0" value="0" style="width:40%"> days</td>
                                                    <td style="width:5%">Rp</td>
                                                    <td style="width:40%"></td>
                                                </tr>
                                                <tr>
                                                    <td>Transportation</td>
                                                    <td><input type="number" min="0" value="0" style="width:40%"> days</td>
                                                    <td>Rp</td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan=2>Total Cash Advanced</td>
                                                    <td>Rp</td>
                                                    <td></td>
                                                </tr>
                                            </tbody>
