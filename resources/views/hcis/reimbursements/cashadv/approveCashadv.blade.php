    ...
    <div class="container-fluid">
        ...
        <div class="row g-2 justify-content-center">
            <div class=" col-6 col-sm-auto">
                <div class="mb-2">
                    <a href="{{ route('cashadvanced_approve') }}" class="btn btn-primary rounded-pill shadow w-100 position-relative">
                        Cash Advanced
                        @if ( $pendingCACount >= 1 )
            ...
            <div class="col-6 col-sm-auto">
                <div class="mb-2">
                    <a href="{{ route('cashadvanced.form') }}" class="btn btn-primary rounded-pill shadow w-100 position-relative">
                        Medical
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('cashadvanced_approve.approve', encrypt($ca_transaction->id)) }}" class="btn btn-sm rounded-pill btn-primary" title="Edit" ><i class="ri-edit-box-line"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
