                                    ...
                                    @foreach ($ca_transactions as $ca_transaction)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class=""
                                                    style="display: {{ $ca_transaction->approval_status == 'Approved' ? 'none' : 'inline-block' }}">
                                                    <a href="{{ route('cashadvanced.edit', $ca_transaction->id) }}"
                                                        class="mx-1 btn btn-sm btn-outline-warning" title="Edit"><i
                                                            class="ri-edit-box-line"></i></a>
                                                    <form action="{{ route('cashadvanced.delete', $ca_transaction->id) }}"
                                                ...
                                                <div
                                                    style="display: {{ $ca_transaction->approval_status == 'Approved' ? 'inline-block' : 'none' }}">
                                                    <a href="{{ route('cashadvanced.download', $ca_transaction->id) }}"
                                                        target="_blank" class="btn btn-sm rounded-pill btn-primary"
                                                        title="Print"><i class="ri-printer-line"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
