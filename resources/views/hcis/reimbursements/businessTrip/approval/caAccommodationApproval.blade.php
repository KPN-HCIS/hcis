        ...
        @foreach ($detailCA['detail_penginapan'] as $penginapan)
            <div id="form-container-bt-penginapan-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Accommodation Start Plan</label>
                        <input type="date" name="start_bt_penginapan[]" id="start_bt_penginapan_{{ $loop->index + 1 }}"
                            class="form-control start-penginapan bg-light" value="{{ $penginapan['start_date'] }}"
                    ...
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Accommodation End Plan</label>
                        <input type="date" name="end_bt_penginapan[]" id="end_bt_penginapan_{{ $loop->index + 1 }}"
                            class="form-control end-penginapan bg-light" value="{{ $penginapan['end_date'] }}"
                            placeholder="mm/dd/yyyy"
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <div class="input-group">
                            <input class="form-control bg-light total-days-penginapan"
                                id="total_days_bt_penginapan_{{ $loop->index + 1 }}" name="total_days_bt_penginapan[]"
                                type="number" min="0" value="{{ $penginapan['total_days'] }}" readonly>
                            <div class="input-group-append">
                                <span class="input-group-text">days</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" name="hotel_name_bt_penginapan[]" class="form-control bg-light"
                            placeholder="Hotel" id="hotel_name_bt_penginapan_{{ $loop->index + 1 }}"
                            value="{{ $penginapan['hotel_name'] }}" readonly>
                    </div>
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Company Code</label>
                        <select class="form-control select2 bg-light" id="company_bt_penginapan_{{ $loop->index + 1 }}"
    ...
    <div id="form-container-penginapan">
        <div id="form-container-bt-penginapan-1" class="card-body bg-light p-2 mb-3">
            <div class="row">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <div class="input-group">
                        <input class="form-control bg-light total-days-penginapan" id="total_days_bt_penginapan_1"
                            name="total_days_bt_penginapan[]" type="number" min="0" value="0" readonly>
                        <div class="input-group-append">
                            <span class="input-group-text">days</span>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-2">
                    <label class="form-label">Company Code</label>
                    <select class="form-control select2 bg-light" id="company_bt_penginapan_1" name="company_bt_penginapan[]" disabled>
                        <option value="">Select Company...</option>
                        @foreach ($companies as $company)
                            <option value="{{ $company->contribution_level_code }}">
                                {{ $company->contribution_level . ' (' . $company->contribution_level_code . ')' }}
