<script>
    ...
    function calculateTotalNominalBTTransport() {
        ...
        document.querySelector('input[name="total_bt_transport"]').value = formatNumber(
        total); // Tampilkan dengan format
    }
            ...
            <div id="form-container-bt-transport-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="mb-2">
                            <label class="form-label">Information</label>
                            <textarea name="keterangan_bt_transport[]" class="form-control bg-light" placeholder="Write your information ..." readonly>{{ $transport['keterangan'] }}</textarea>
                        </div>
                    </div>
                </div>
                <br>
    ...
    <div id="form-container-transport">
        <div id="form-container-bt-transport-1" class="card-body bg-light p-2 mb-3" style="border-radius: 1%;">
            <div class="row">
                ...
                <div class="col-md-4 mb-2">
                    <label class="form-label" for="name">Company Code</label>
                    <select class="form-control select2 bg-light" id="company_bt_transport_1"
                        name="company_bt_transport[]" disabled>
                        <option value="">Select Company...</option>
                        @foreach ($companies as $company)
                            <option value="{{ $company->contribution_level_code }}">
                ...
                <div class="col-md-12 mb-2">
                    <div class="mb-2">
                        <label class="form-label">Information</label>
                        <textarea name="keterangan_bt_transport[]" placeholder="Write your information ..." class="form-control bg-light"
                            readonly></textarea>
                    </div>
                </div>
            </div>
