            ...
            <div id="form-container-bt-perdiem-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3" style="border-radius: 1%;">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select class="form-control select2 bg-light" id="company_bt_perdiem_{{ $loop->index + 1 }}" name="company_bt_perdiem[]" disabled>
                            <option value="">Select Company...</option>
                            @foreach($companies as $company)
                                <option value="{{ $company->contribution_level_code }}"
                    ...
                    <div class="col-md-6 mb-2">
                        <label class="form-label" for="locationFilter">Location Agency</label>
                        <select class="form-control location-select bg-light" name="location_bt_perdiem[]" id="location_bt_perdiem[]" disabled>
                            <option value="">Select location...</option>
                            @foreach($locations as $location)
                                <option value="{{ $location->area }}"
                            ...
                            @endforeach
                            <option value="Others" @if('Others' == $perdiem['location']) selected disabled @endif>Others</option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Start Perdiem</label>
                        <input type="date" name="start_bt_perdiem[]" class="form-control start-perdiem bg-light" value="{{$perdiem['start_date']}}" placeholder="mm/dd/yyyy"
                    ...
                    <div class="col-md-4 mb-2">
                        <label class="form-label">End Perdiem</label>
                        <input type="date" name="end_bt_perdiem[]" class="form-control end-perdiem bg-light" value="{{$perdiem['end_date']}}" placeholder="mm/dd/yyyy"
                            onchange="calculateTotalDaysPerdiem(this)" readonly>
                    </div>
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Total Days</label>
        ...
        <div id="form-container-bt-perdiem-1" class="card-body bg-light p-2 mb-3" style="border-radius: 1%;">
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <select class="form-control select2 bg-light" id="company_bt_perdiem_1" name="company_bt_perdiem[]" disabled>
                ...
                <div class="col-md-6 mb-2">
                    <label class="form-label" for="locationFilter">Location Agency</label>
                    <select class="form-control location-select bg-light" name="location_bt_perdiem[]" id="location_bt_perdiem_${formCount}" disabled>
                        <option value="">Select Location...</option>
                        @foreach ($locations as $location)
                            <option value="{{ $location->area }}">
                                {{ $location->area . ' (' . $location->company_name . ')' }}
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-2">
                    <label class="form-label">Start Perdiem</label>
                    <input type="date" name="start_bt_perdiem[]" class="form-control start-perdiem bg-light" placeholder="mm/dd/yyyy"
                        onchange="calculateTotalDaysPerdiem(this)" readonly>
                </div>
                ...
                <div class="col-md-4 mb-2">
                    <label class="form-label">End Perdiem</label>
                    <input type="date" name="end_bt_perdiem[]" class="form-control end-perdiem bg-light" placeholder="mm/dd/yyyy"
                        onchange="calculateTotalDaysPerdiem(this)" readonly>
                </div>
                <div class="col-md-4 mb-2">
                    <label class="form-label">Total Days</label>
            ...
            <div class="input-group">
                ...
                <input class="form-control bg-light" name="nominal_bt_perdiem[]" id="nominal_bt_perdiem_1" type="text" value="0" onchange="onNominalChange()" readonly>
            </div>
            <br>
        </div>
    </div>
