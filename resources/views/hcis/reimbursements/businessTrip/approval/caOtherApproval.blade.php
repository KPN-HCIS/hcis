        ...
        @foreach ($detailCA['detail_lainnya'] as $lainnya)
            <div id="form-container-bt-lainnya-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        <label class="form-label">Date</label>
                        <input type="date" name="tanggal_bt_lainnya[]" class="form-control bg-light" value="{{$lainnya['tanggal']}}" placeholder="mm/dd/yyyy" readonly>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label class="form-label">Amount</label>
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control bg-light" name="nominal_bt_lainnya[]" id="nominal_bt_lainnya_{{ $loop->index + 1 }}" type="text" min="0" value="{{ number_format($lainnya['nominal'], 0, ',', '.') }}" onfocus="this.value = this.value === '0' ? '' : this.value;" oninput="formatInput(this)" onblur="formatOnBlur(this)" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="mb-2">
                            <label class="form-label">Information</label>
                            <textarea name="keterangan_bt_lainnya[]" class="form-control bg-light" placeholder="Write your information ..." readonly>{{ $lainnya['keterangan'] }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="form-container-lainnya">
        <div id="form-container-bt-lainnya-1" class="card-body bg-light p-2 mb-3">
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <label class="form-label">Date</label>
                    <input type="date" name="tanggal_bt_lainnya[]" class="form-control bg-light" placeholder="mm/dd/yyyy" readonly>
                </div>
                <div class="col-md-6 mb-2">
                    <label class="form-label">Amount</label>
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control bg-light" name="nominal_bt_lainnya[]" id="nominal_bt_lainnya_1" type="text" min="0" value="0" onfocus="this.value = this.value === '0' ? '' : this.value;" oninput="formatInput(this)" onblur="formatOnBlur(this)" readonly>
                    </div>
                </div>
