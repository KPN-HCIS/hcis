        ...
        <div class="table-responsive-sm">
            <div class="row mb-2">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control form-control-sm bg-light" id="date_required" name="date_required"
                        placeholder="Date Required" onchange="" value="{{ $ca->date_required ?? 0 }}" readonly>
                </div>
