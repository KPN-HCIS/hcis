                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select select2" name="noktp_tkt[]" id="noktp_tkt">
                                        <option value="" disabled selected>--- Choose Passengers ---</option>
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->ktp }}">
                                                {{ $employee->fullname . ' - ' . $employee->ktp }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-sm btn-outline-primary add-ticket-btn">Add
                                    Ticket Data</button>
