<div class="container-fluid">
    <div id="hotel_div">
        <div class="d-flex flex-column gap-1" id="hotel_forms_container">
            <?php for ($i = 1; $i <= 5; $i++) : ?>
            <div class="card bg-light" id="hotel-form-<?php echo $i; ?>" style="display: <?php echo $i === 1 ? 'block' : 'none'; ?>;">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-2">
                            ...
                            <input type="number" class="form-control bg-light" name="total_hari[]" readonly>
                        </div>
                    </div>
                    <div class="mt-2">
