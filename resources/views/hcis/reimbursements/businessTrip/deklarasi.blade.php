                        ...
                        <form action="/businessTrip/update/{{ $n->id }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="unit_1" name="unit_1" disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="atasan_1" name="atasan_1" disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control" id="email_1" name="email_1"
                                        placeholder="Email Atasan 1" value="{{ $n->email_1 }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="unit_2" name="unit_2" disabled>
                                        <option selected disabled>-- Pilih Unit --</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="atasan_2" name="atasan_2" disabled>
                                        <option selected disabled>-- Pilih Atasan --</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control" id="email_2" name="email_2"
                                        placeholder="Email Atasan 2" value="{{ $n->email_2 }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control datepicker" id="mulai" name="mulai"
                                        placeholder="Tanggal Mulai" value="{{ $n->mulai }}" disabled>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control datepicker" id="kembali" name="kembali"
                                        placeholder="Tanggal Kembali" value="{{ $n->kembali }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tujuan" name="tujuan"
                                    placeholder="Tujuan" value="{{ $n->tujuan }}" disabled>
                            </div>

                            <div class="mb-3">
                                <label for="keperluan" class="form-label">Keperluan (Agar diisi sesuai kunjungan
                                    dinas)</label>
                                <textarea class="form-control" id="keperluan" name="keperluan" rows="3" disabled>{{ $n->keperluan }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="bb_perusahaan_{{ $n->id }}" class="form-label">Beban Biaya Perusahaan (PT Keperluan Dinas / Bukan PT Payroll)</label>
                                <select class="form-select" id="bb_perusahaan_{{ $n->id }}" name="bb_perusahaan" disabled>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="norek_krywn" name="norek_krywn"
                                    placeholder="No Rekening" value="{{ $n->norek_krywn }}" disabled>
                            </div>

                            <div class="mb-3">
                                <label for="nama_bank" class="form-label">Nama Bank Karyawan</label>
                                <input type="text" class="form-control" id="nama_bank" name="nama_bank"
                                    placeholder="Nama Bank" value="{{ $n->nama_bank }}" disabled>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_pemilik_rek" name="nama_pemilik_rek"
                                    placeholder="Nama Pemilik Rekening" value="{{ $n->nama_pemilik_rek }}" disabled>
                            </div>
