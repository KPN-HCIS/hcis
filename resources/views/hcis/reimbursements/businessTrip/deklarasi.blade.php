        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <form action="/businessTrip/update/{{ $n->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="no_sppd" class="form-label">No SPPD</label>
                                <input type="text" class="form-control bg-light" id="no_sppd" name="no_sppd" value="{{ $n->no_sppd }}" readonly>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="mulai" class="form-label">Start Date</label>
                                    <input type="date" class="form-control bg-light" id="mulai" name="mulai" value="{{ $n->mulai }}" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label for="kembali" class="form-label">End Date</label>
                                    <input type="date" class="form-control bg-light" id="kembali" name="kembali" value="{{ $n->kembali }}" readonly>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" name="uang_saku_total" readonly></td>
                                                <td><input type="text" class="form-control" name="uang_saku_keterangan"></td>
                                            </tr>
                                            <tr>
                                                <td>Transportation</td>
                                                <td><input type="number" class="form-control" name="uang_saku_jumlah"></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th><input type="number" class="form-control" name="total_realisasi" readonly></th>
                                                <th></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="struk" name="struk" accept="image/*" class="form-control">
                            </div>
