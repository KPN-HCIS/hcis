                                                                                            ...
                                                                                            @foreach ($detailPerdiem as $index => $perdiem)
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        value="{{ old('start_bt_perdiem.' . $index, $perdiem['start_date'] ?? '') }}" disabled>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="mb-2">
                                                                                                    <label
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        value="{{ old('end_bt_perdiem.' . $index, $perdiem['end_date'] ?? '') }}" disabled>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="mb-2">
                                                                                                    <label
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        <option
                                                                                                            value="Others"
                                                                                                            {{ ($perdiem['location'] ?? '') == 'Others' ? 'selected' : '' }} disabled>
                                                                                                            Others
                                                                                                        </option>
                                                                                                    </select>
                                                                                                    <br>
                                                                                                    <input
                                                                                                        ...
                                                                                                        style="{{ ($perdiem['location'] ?? '') == 'Others' ? 'display:block;' : 'display:none;' }}" disabled>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="mb-2">
                                                                                                    <label
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        type="text"
                                                                                                        min="0"
                                                                                                        value="{{ old('nominal_bt_perdiem.' . $index, $perdiem['nominal'] ?? '') }}" disabled>
                                                                                                </div>
                                                                                                <hr
                                                                                            ...
                                                                                            @foreach ($detailTransport as $index => $transport)
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        value="{{ old('tanggal_bt_transport.' . $index, $transport['tanggal'] ?? '') }}" disabled>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="mb-2">
                                                                                                    <label
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <textarea name="keterangan_bt_transport[]" class="form-control" placeholder="Write your information here..." disabled>{{ old('keterangan_bt_transport.' . $index, $transport['keterangan'] ?? '') }}</textarea>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="mb-2">
                                                                                                    <label
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        type="text"
                                                                                                        min="0"
                                                                                                        value="{{ old('nominal_bt_transport.' . $index, $transport['nominal'] ?? '0') }}" disabled>
                                                                                                </div>
                                                                                                ...
                                                                                                @foreach ($penginapan as $index => $item)
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            placeholder="mm/dd/yyyy"
                                                                                                            value="{{ old('start_bt_penginapan.' . $index, $item['start_date'] ?? '') }}" disabled>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="mb-2">
                                                                                                        <label
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            placeholder="mm/dd/yyyy"
                                                                                                            value="{{ old('end_bt_penginapan.' . $index, $item['end_date'] ?? '') }}" disabled>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="mb-2">
                                                                                                        <label
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            value="{{ old('hotel_name_bt_penginapan.' . $index, $item['hotel_name'] ?? '') }}" disabled>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="mb-2">
                                                                                                        <label
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            type="text"
                                                                                                            min="0"
                                                                                                            value="{{ old('nominal_bt_penginapan.' . $index, $item['nominal'] ?? '0') }}" disabled>
                                                                                                    </div>
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    type="text"
                                                                                                                    min="0"
                                                                                                                    value="{{ old('nominal_bt_lainnya.' . $index, $lainnyaItem['nominal'] ?? '0') }}" disabled>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <hr
                                                                                                            class="border border-primary border-1 opacity-50">
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control bg-light"
                                                                    name="totalca_deklarasi" id="totalca" type="text"
                                                                    min="0"
