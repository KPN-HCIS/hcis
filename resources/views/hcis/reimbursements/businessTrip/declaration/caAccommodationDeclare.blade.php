...
@if (!empty($detailCA['detail_penginapan']) && $detailCA['detail_penginapan'][0]['start_date'] !== null)
    <div id="form-container-penginapan">
        @foreach ($detailCA['detail_penginapan'] as $penginapan)
            <div id="form-container-bt-penginapan-{{ $loop->index + 1 }}" class="p-2 mb-4 rounded-3"
                ...
                <div id="form-container-bt-penginapan-dec-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3"
                    style="border-radius: 1%;">
    ...
    <div class="row mt-2">
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input class="form-control bg-light" name="total_bt_penginapan" id="total_bt_penginapan"
                    type="text" min="0"
                    value="{{ number_format(array_sum(array_column($declareCA['detail_penginapan'] ?? [], 'nominal')), 0, ',', '.') }}"
                    readonly>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="text" name="hotel_name_bt_penginapan[]" class="form-control" placeholder="Hotel"
                        id="hotel_name_bt_penginapan_1">
                </div>
                <div class="col-md-4 mb-2">
                    <label class="form-label">Company Code</label>
                    <select class="form-control select2" id="company_bt_penginapan_1" name="company_bt_penginapan[]">
                        <option value="">Select Company...</option>
                        @foreach ($companies as $company)
                            <option value="{{ $company->contribution_level_code }}">
                                {{ $company->contribution_level . ' (' . $company->contribution_level_code . ')' }}
