...
@if (!empty($detailCA['detail_transport']) && $detailCA['detail_transport'][0]['tanggal'] !== null)
    <div id="form-container-transport">
        @foreach ($detailCA['detail_transport'] as $index => $transport)
            <div id="form-container-bt-transport-{{ $loop->index + 1 }}" class="p-2 mb-4 rounded-3"
                    ...
                    <div class="row mt-3">
                        <div class="d-flex justify-start w-100">
                            ...
                            <button class="btn btn-warning mr-2"
                                onclick="removeFormTransportDec({{ $loop->index + 1 }}, event)">Delete</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mt-3">
        <button class="btn btn-primary" id="addMoreButtonTransport" onclick="addMoreFormTransport(event)">Add
            More</button>
    </div>
