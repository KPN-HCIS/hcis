<script>
    ...
    function addMoreFormPerdiem(event) {
        ...
        newForm.innerHTML = `
            <div class="row">
                <!-- Company Code -->
                <p class="fs-5 text-primary" style="font-weight: bold;">Perdiem Declaration ${formCountPerdiem}</p>
            ...
            <div id="form-container-bt-perdiem-{{ $loop->index + 1 }}" class="p-2 mb-4 rounded-3"
                ...
                <div id="form-container-bt-perdiem-req-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <table class="table"
                                style="border: none; border-collapse: collapse; width: 100%; margin: 0; padding: 0;">
                                <tr style="margin: 0; padding: 0;">
                                    <th class="label" style="border: none; width: 40%; padding: 2px 0;">Start Perdiem
                                    </th>
                                    <td class="colon" style="border: none; width: 1%; padding: 2px 0;">:</td>
                                    <td class="value" style="border: none; padding: 2px 0;">
                                ...
                                <tr style="margin: 0; padding: 0;">
                                    <th class="label" style="border: none; padding: 2px 0;">End Perdiem</th>
                                    <td class="colon" style="border: none; padding: 2px 0;">:</td>
                                    <td class="value" style="border: none; padding: 2px 0;">
                    ...
                    <div class="row mt-3">
                        <div class="d-flex justify-start w-100">
                            ...
                            {{-- <button class="btn btn-warning mr-2"
                                onclick="removeFormPerdiemDec({{ $loop->index + 1 }}, event)">Delete</button> --}}
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <div class="input-group">
                                <input class="form-control bg-light total-days-perdiem" name="total_days_bt_perdiem[]"
                                    type="number" value="{{ $perdiem_dec['total_days'] }}" readonly>
                                <div class="input-group-append">
                                    <span class="input-group-text">days</span>
                                </div>
                            </div>
