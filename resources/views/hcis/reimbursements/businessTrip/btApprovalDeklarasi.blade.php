                        ...
                        <form action="/businessTrip/deklarasi/update/{{ $n->id }}" method="POST" id="btEditForm"
                            ...
                            <div class="row mt-2" id="ca_div">
                                <div class="col-md-6">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap" id="perdiemTable" width="100%"
                                            ...
                                            <thead class="thead-light">
                                                <tr class="bg-primary">
                                                    <th colspan="7" class="text-center text-white"><b>Perdiem Plan
                                                            :</b></th>
                                                </tr>
                                            ...
                                            <tbody>
                                                <?php $totalPerdiem = 0;
                                                $totalDays = 0; ?>
                                                @if (isset($caDetail['detail_perdiem']) && is_array($caDetail['detail_perdiem']))
                                                    @foreach ($caDetail['detail_perdiem'] as $perdiem)
                                                        <tr class="text-center">
                                                            ...
                                                            <td style="text-align: right">
                                                                Rp.
                                                                {{ number_format(floatval($perdiem['nominal'] ?? '0'), 0, ',', '.') }}
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $totalPerdiem += floatval($perdiem['nominal'] ?? '0');
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap"
                                            ...
                                            <tbody>
                                                ...
                                                @if (isset($caDetail['detail_transport']) && is_array($caDetail['detail_transport']))
                                                    @foreach ($caDetail['detail_transport'] as $transport)
                                                        <tr class="text-center">
                                                            <td class="text-center">{{ $loop->index + 1 }}</td>
                                                            <td>{{ isset($transport['tanggal']) ? \Carbon\Carbon::parse($transport['tanggal'])->format('d-M-y') : '-' }}
                                                            </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right">Rp.
                                                        {{ number_format($totalTransport, 0, ',', '.') }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap" id="penginapanTable"
                                            ...
                                            <tbody>
                                                ...
                                                $totalDays = 0; ?>
                                                @if (isset($caDetail['detail_penginapan']) && is_array($caDetail['detail_penginapan']))
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap" id="otherTable" width="100%"
                                            cellspacing="0">
                                            <thead class="thead-light">
                                                <tr class="bg-primary">
                                            ...
                                            <tbody>
                                                <?php $totalLainnya = 0; ?>
                                                @if (isset($caDetail['detail_lainnya']) && is_array($caDetail['detail_lainnya']))
                                ...
                                <div class="col-md-6">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap" id="perdiemTableDec"
                                            ...
                                            <tbody>
                                                ...
                                                $totalDays = 0;
                                                ?>
                                                @if (isset($declareCa['detail_perdiem']) && is_array($declareCa['detail_perdiem']))
                                                    @foreach ($declareCa['detail_perdiem'] as $perdiem)
                                                        <tr class="text-center">
                                                            ...
                                                            <td>{{ $perdiem['company_code'] ?? '-' }}</td>
                                                            <td>{{ $perdiem['total_days'] ? $perdiem['total_days'] . ' Days' : '-' }}
                                                            </td>
                                                            <td style="text-align: right">
                                                                Rp.
                                                                {{ number_format(floatval($perdiem['nominal'] ?? '0'), 0, ',', '.') }}
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><strong>{{ $totalDays }} Days</strong></td>
                                                    <td style="text-align: right"><strong>Rp.
                                                            {{ number_format($totalPerdiem, 0, ',', '.') }}</strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap" id="transportTableDec"
                                            width="100%" cellspacing="0">
                                            <thead class="thead-light">
                                                <tr class="bg-primary">
                                            ...
                                            <tbody>
                                                <?php $totalTransport = 0; ?>
                                                @if (isset($declareCa['detail_transport']) && is_array($declareCa['detail_transport']))
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap" id="penginapanTableDec"
                                            width="100%" cellspacing="0">
                                            <thead class="thead-light">
                                                <tr class="bg-primary">
                                                    <th colspan="7" class="text-center text-white">Accommodation Plan
                                            ...
                                            <tbody>
                                                ...
                                                $totalDays = 0;
                                                ?>
                                                @if (isset($declareCa['detail_penginapan']) && is_array($declareCa['detail_penginapan']))
                                                    @foreach ($declareCa['detail_penginapan'] as $penginapan)
                                                        <tr style="text-align-last: center;">
                                                            <td>{{ $loop->index + 1 }}</td>
                                                            <td>
                                                                @if (isset($penginapan['start_date']) && $penginapan['start_date'])
                                                                    {{ \Carbon\Carbon::parse($penginapan['start_date'])->format('d-M-y') }}
                                                                @else
                                                                    -
                                                                @endif
                                                            </td>
                                                            <td>
                                                                @if (isset($penginapan['end_date']) && $penginapan['end_date'])
                                                                    {{ \Carbon\Carbon::parse($penginapan['end_date'])->format('d-M-y') }}
                                                                @else
                                                                    -
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td>{{ $penginapan['company_code'] ?? '-' }}</td>
                                                            <td>
                                                                @if (isset($penginapan['total_days']) && $penginapan['total_days'] !== '')
                                                                    {{ $penginapan['total_days'] }} Days
                                                                @else
                                                                    -
                                                                @endif
                                                            </td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td style="text-align: right">
                                                        <strong>Rp.
                                                            {{ number_format($totalPenginapan, 0, ',', '.') }}</strong>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm nowrap" id="otherTableDec"
                                            width="100%" cellspacing="0">
                                            <thead class="thead-light">
                                                <tr class="bg-primary">
                                            ...
                                            <tbody>
                                                <?php $totalLainnya = 0; ?>
                                                @if (isset($declareCa['detail_lainnya']) && is_array($declareCa['detail_lainnya']))
                                                    @foreach ($declareCa['detail_lainnya'] as $lainnya)
                                                        <tr>
                                                            <td class="text-center">{{ $loop->index + 1 }}</td>
                                                            <td class="text-center">
                                                                @if (isset($lainnya['tanggal']) && $lainnya['tanggal'])
                                                                    {{ \Carbon\Carbon::parse($lainnya['tanggal'])->format('d-M-y') }}
                                                                @else
                                                                    -
                                                                @endif
                                                            </td>
                                                            <td class="text-center">{{ $lainnya['keterangan'] ?? '-' }}
                                                            </td>
                                                            <td style="text-align: right">
                                                                Rp.
                                                                {{ number_format(floatval($lainnya['nominal'] ?? 0), 0, ',', '.') }}
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td style="text-align: right">
                                                        <strong>Rp.
                                                            {{ number_format($totalLainnya, 0, ',', '.') }}</strong>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
