    ...
    <ul class="nav nav-pills nav-tabs" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation" id="nav-perdiem">
            <a href="{{ route('approval.cashadvanced') }}" style="border-radius: 10px 10px 0px 0px"
                ...
                aria-controls="pills-perdiem" aria-selected="false">Cash Advanced Approval
                @if ($totalPendingCount >= 1)
                    <span class="badge bg-danger position-absolute top-10 start-10 mx-2 translate-middle rounded-circle">{{ $totalPendingCount }}</span>
                @endif
            </a>
        </li>
        <li class="nav-item" role="presentation" id="nav-cashAdvanced">
            <a href="{{ route('businessTrip.approval') }}" style="border-radius: 10px 10px 0px 0px"
                ...
                aria-controls="pills-cashAdvanced" aria-selected="false">
                Bussiness Trip Approval
                @if ($totalBTCount >= 1)
                    <span class="badge bg-danger position-absolute top-10 start-10 mx-2 translate-middle rounded-circle">{{ $totalBTCount }}</span>
                @endif
            </a>
        </li>
        <li class="nav-item" role="presentation" id="nav-ticket">
            <a href="{{ route('ticket.approval') }}" style="border-radius: 10px 10px 0px 0px"
                ...
                aria-controls="pills-ticket" aria-selected="false">Ticket Approval
                @if ($totalTKTCount >= 1)
                    <span class="badge bg-danger position-absolute top-10 start-10 mx-2 translate-middle rounded-circle">{{ $totalTKTCount }}</span>
                @endif
            </a>
        </li>
        <li class="nav-item" role="presentation" id="nav-hotel">
            <a href="{{ route('hotel.approval') }}" style="border-radius: 10px 10px 0px 0px"
                ...
                aria-controls="pills-hotel" aria-selected="false">Hotel Approval
                @if ($totalHTLCount >= 1)
                    <span class="badge bg-danger position-absolute top-10 start-10 mx-2 translate-middle rounded-circle">{{ $totalHTLCount }}</span>
                @endif
            </a>
        </li>
        <li class="nav-item" role="presentation" id="nav-medical">
            <a href="{{ route('medical.approval') }}" style="border-radius: 10px 10px 0px 0px"
                ...
                aria-controls="pills-medical" aria-selected="false">Medical Approval
                @if ($totalMDCCount >= 1)
                    <span class="badge bg-danger position-absolute top-10 start-10 mx-2 translate-middle rounded-circle">{{ $totalMDCCount }}</span>
                @endif
            </a>
        </li>
