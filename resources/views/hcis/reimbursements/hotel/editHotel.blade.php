                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="lokasi_htl" id="lokasi_htl" class="form-control" value="{{ $transactions->lokasi_htl }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-2">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <select class="form-control" name="bed_htl" required>
                                            ...
                                            <option value="Extra Bed" {{ $transactions->bed_htl == 'Extra Bed' ? 'selected' : '' }}>Extra Bed</option>
                                            <option value="Baby Cot" {{ $transactions->bed_htl == 'Baby Cot' ? 'selected' : '' }}>Baby Cot</option>
                                            <option value="Sofa Bed" {{ $transactions->bed_htl == 'Sofa Bed' ? 'selected' : '' }}>Sofa Bed</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="date" name="tgl_masuk_htl" id="tgl_masuk_htl" class="form-control" value="{{ $transactions->tgl_masuk_htl }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        <label class="form-label" for="start">End Date</label>
                                        <input type="date" name="tgl_keluar_htl" id="tgl_keluar_htl" class="form-control" value="{{ $transactions->tgl_keluar_htl }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control bg-light" id="totaldays" name="totaldays" type="text" min="0" value="{{ $transactions->total_hari }}" readonly>
