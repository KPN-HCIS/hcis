                ...
                <table class="table table-bordered" id="taskTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5"><a href="#" id="approval" data-id="{{ $row->employee_id }}" class="badge {{ $row->goal->form_status == 'Draft' ? 'badge-secondary' : ($row->status === 'Approved' ? 'badge-success' : 'badge-warning')}} badge-pill w-100">{{ $row->goal->form_status == 'Draft' ? 'Draft':$row->status }}</a></td>
